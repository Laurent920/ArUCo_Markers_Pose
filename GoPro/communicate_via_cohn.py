...
async def main(ip_address: str, username: str, password: str, certificate: Path) -> None:
    ...
    shutter_start = "/gopro/camera/shutter/start"
    shutter_stop = "/gopro/camera/shutter/stop"
    stream_start = "/gopro/camera/stream/start"
    stream_stop = "/gopro/camera/stream/stop"
    url = f"https://{ip_address}" + shutter_stop
...
if __name__ == "__main__":
    ...
    try:
        # python communicate_via_cohn.py "192.168.0.60" gopro dNBAzYcggkkE cohn.crt
